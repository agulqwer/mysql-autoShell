...
# installed.
TCL_PREFIX='/usr/local/tcl'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/usr/local/tcl'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/usr/local/src/mysql/tar/tcl8.6.10/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/usr/local/tcl/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/usr/local/tcl/include'
...
# compiled.
TCL_SRC_DIR='/usr/local/src/mysql/tar/tcl8.6.10'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/usr/local/tcl/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/usr/local/src/mysql/tar/tcl8.6.10/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/usr/local/tcl/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/usr/local/src/mysql/tar/tcl8.6.10/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/usr/local/tcl/lib/libtclstub8.6.a'
